    ...
    return (
        ...
        >
            ...
            <TableCell className="flex gap-3" align="right">
                <DeleteForeverSharpIcon onClick={() => setOpenModalDelete(true)} cursor='pointer' className="text-red-500" />
                ...
                <AppRegistrationSharpIcon onClick={() => setOpenModalEdit(true)} cursor='pointer' className="text-blue-500" />
